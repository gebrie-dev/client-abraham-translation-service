          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                About Abraham Translation Service
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                With over 15 years of experience in professional translation
                services, Abraham Translation Service has built a reputation for
                accuracy, reliability, and exceptional customer service.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Our team of certified translators specializes in legal, medical,
                and technical documents, ensuring that every translation meets
                the highest standards of quality and confidentiality.
              </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Rush orders available with 24-hour turnaround
                    </p>
                  </div>
                </div>
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to get started? Contact us for a free quote or to discuss
